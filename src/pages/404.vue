<template>
  <Layout>
    <div class="h-screen">
      ...
      <div id="thankyou" class="container absolute m-auto text-center right-0 left-0">
        <h1 class="text-white text-6xl font-bold">404</h1>
        <h3>Parece que essa página não existe. :(</h3>
        <a class="mt-4 inline-block bg-gray-100 border-3 border-red-800 py-3 px-5 rounded-full tracking-wide" href="https://sottilealimentos.com.br">Voltar para a página inicial</a>
      </div>
